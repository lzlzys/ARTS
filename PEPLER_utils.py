...
import pickle
import datetime
from PEPLER_rouge import rouge
from PEPLER_bleu import compute_bleu
import numpy as np
...
class DataLoader:
    def __init__(self, data_path, index_dir, tokenizer, seq_len, args_str):
        ...
        self.train, self.valid, self.test, self.user2feature, self.item2feature = self.load_data1(args_str)
    ...
    def load_data1(self, args_str):
        ...
        j = np.load('../new_lzl_model/data/10_core_{}_PEPLER.npy'.format(args_str), allow_pickle=True)
        h = 1
        for review in j:
        ...
        return new_train, new_valid, new_test, 0, 0
